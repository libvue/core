<template>
    <lv-layout debug>
        <template #header>
            <lv-header>
                <template #branding>
                    <svg v-space-after="0.5" viewBox="0 0 938 235" xmlns="http://www.w3.org/2000/svg" class="logo" @click="$router.push('/')">
                ...
                <template #navigation>
                    <lv-horizontal-nav-item v-space-after="1" label="Documentation" to="install" />
