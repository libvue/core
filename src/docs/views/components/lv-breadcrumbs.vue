<template>
    <lv-heading :level="3" v-space-after="0.5">Breadcrumbs</lv-heading>
    <lv-heading sub :level="6" v-space-after="1">Visualize the path</lv-heading>
...
<script>
const code = `<lv-breadcrumbs :crumbs="crumbs" home-path="/" show-home />`;
const codeScript = `
export default {
    data() {
        return {
