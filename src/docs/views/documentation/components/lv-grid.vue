<template>
    ...
    <lv-heading v-space-after="2" sub :level="6">Responsive grid</lv-heading>
    ...
    <component-details
        v-space-after="1"
        title="Grid Row"
        component-path="../../lib/components/LvGrid/LvGridRow.vue"
    ></component-details>

    <component-details
        v-space-after="1"
        title="Grid Column"
        component-path="../../lib/components/LvGrid/LvGridColumn.vue"
    ></component-details>
</template>
