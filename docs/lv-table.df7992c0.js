import{_ as O,b as a,d as S,o as g,c as y,w as r,e as m,f as l,g as n,F as G,h as s,t as c}from"./index.f2b50de5.js";const A=`
...
`.trim(),T={data(){return{activeSortFile:"template",sortFiles:[{id:"template",filename:"template",code:C,lang:"html"},{id:"script",filename:"script",code:N,lang:"js"}],activeDefaultFile:"template",defaultFiles:[{id:"template",filename:"template",code:x,lang:"html"},{id:"script",filename:"script",code:B,lang:"js"}],activeOptionsFile:"template",optionsFiles:[{id:"template",filename:"template",code:A,lang:"html"},{id:"script",filename:"script",code:k,lang:"js"}],activeTab:"default",tabs:[{id:"default",title:"Default",icon:"table"},{id:"options",title:"With Options",icon:"more-vertical"},{id:"sorting",title:"Sorting",icon:"sort-desc"},{id:"empty",title:"Empty",icon:"eraser"}],rowsDefault:[{age:33,gender:"male",name:"Bob",weight:80,hello:"world"},{age:43,gender:"female",name:"Jane",weight:69,hello:"world"},{age:56,gender:"male",name:"George",weight:131,hello:"world"}],columnsDefault:{name:{title:"Name"},gender:{title:"Gender",align:"center"},age:{title:"Age",align:"center"},weight:{title:"Weight",align:"center"}},rowsOptions:[{id:1,age:33,gender:"male",name:"Bob",weight:80},{id:2,age:43,gender:"female",name:"Jane",weight:69},{id:3,age:56,gender:"male",name:"George",weight:131}],columnsOptions:{name:{title:"Name"},gender:{title:"Gender",align:"center"},age:{title:"Age",align:"center"},weight:{title:"Weight",align:"center"},options:{title:null,align:"right",fitContent:!0}},sort:"weight",rowsSorting:[{id:1,age:33,gender:"male",name:"Bob",weight:80},{id:2,age:43,gender:"female",name:"Jane",weight:69},{id:3,age:56,gender:"male",name:"George",weight:131}],columnsSorting:{name:{title:"Name"},gender:{title:"Gender",align:"center"},age:{title:"Age",align:"center"},weight:{title:"Weight",align:"center",sortable:!0}}}},methods:{rowAction({row:f}){console.log(f)}}},z=s("Table"),W=s("Organize your rows");function J(f,o,j,E,e,h){const w=a("lv-heading"),p=a("lv-table",!0),u=a("lv-card"),d=a("lv-code"),v=a("lv-button"),b=a("lv-flex"),_=a("lv-popover"),D=a("lv-tabs"),F=a("component-details"),i=S("space-after");return g(),y(G,null,[r((g(),m(w,{level:3},{default:l(()=>[z]),_:1})),[[i,.5]]),r((g(),m(w,{sub:"",level:6},{default:l(()=>[W]),_:1})),[[i,2]]),n(D,{tabs:e.tabs,active:e.activeTab,onChangeTab:o[4]||(o[4]=t=>e.activeTab=t)},{default:l(()=>[r((g(),m(u,null,{default:l(()=>[n(p,{rows:e.rowsDefault,columns:e.columnsDefault},{weight:l(({value:t})=>[s(c(t)+" kg ",1)]),age:l(({value:t})=>[s(c(t)+" years ",1)]),_:1},8,["rows","columns"])]),_:1})),[[i,1]]),r(n(d,{files:e.defaultFiles,active:e.activeDefaultFile,onChangeFile:o[0]||(o[0]=t=>e.activeDefaultFile=t)},null,8,["files","active"]),[[i,1]])]),options:l(()=>[r((g(),m(u,null,{default:l(()=>[n(p,{rows:e.rowsOptions,columns:e.columnsOptions,"row-action":h.rowAction},{weight:l(({value:t})=>[s(c(t)+" kg ",1)]),age:l(({value:t})=>[s(c(t)+" years ",1)]),options:l(()=>[n(_,{placement:"left",trigger:"mouseenter focus",interactive:""},{reference:l(()=>[n(v,{size:"small",label:"Options",color:"solid-dimmed-primary"})]),content:l(()=>[n(b,{direction:"column"},{default:l(()=>[n(v,{align:"left",icon:"plus-circle",size:"small",label:"Add",color:"ghost-default"}),n(v,{align:"left",icon:"trash",size:"small",label:"Delete",color:"ghost-default"})]),_:1})]),_:1})]),_:1},8,["rows","columns","row-action"])]),_:1})),[[i,1]]),r(n(d,{files:e.optionsFiles,active:e.activeOptionsFile,onChangeFile:o[1]||(o[1]=t=>e.activeOptionsFile=t)},null,8,["files","active"]),[[i,1]])]),sorting:l(()=>[r((g(),m(u,null,{default:l(()=>[n(p,{rows:e.rowsSorting,columns:e.columnsSorting,sort:e.sort,"onUpdate:sort":o[2]||(o[2]=t=>e.sort=t)},{weight:l(({value:t})=>[s(c(t)+" kg ",1)]),age:l(({value:t})=>[s(c(t)+" years ",1)]),_:1},8,["rows","columns","sort"])]),_:1})),[[i,1]]),r(n(d,{files:e.sortFiles,active:e.activeSortFile,onChangeFile:o[3]||(o[3]=t=>e.activeSortFile=t)},null,8,["files","active"]),[[i,1]])]),empty:l(()=>[r((g(),m(u,null,{default:l(()=>[n(p,{columns:e.columnsDefault},null,8,["columns"])]),_:1})),[[i,1]])]),_:1},8,["tabs","active"]),n(F,{component:"LvTable"})],64)}const L=O(T,[["render",J]]);export{L as default};
