import{_ as u,b as t,d as h,o as l,c as g,w as c,e as p,f as r,g as n,F as x,h as d}from"./index.fff357f5.js";const S=`
...
`.trim(),k={data(){return{activeFile:"template",files:[{id:"template",filename:"template",code:S},{id:"script",filename:"script",code:b}],activeStep:"check",steps:[{id:"files",prefix:"1.",title:"Select",completed:!0},{id:"build",prefix:"2.",title:"Build",completed:!0},{id:"check",prefix:"3.",title:"Check",completed:!1},{id:"publish",prefix:"4.",title:"Publish",completed:!1,disabled:!0}]}}},C=d("Progress Steps"),F=d("Used for showing the completion progress of a task.");function B(P,s,w,D,e,N){const a=t("lv-heading"),f=t("lv-progress-steps",!0),v=t("lv-card"),m=t("lv-code"),_=t("component-details"),i=h("space-after");return l(),g(x,null,[c((l(),p(a,{level:3},{default:r(()=>[C]),_:1})),[[i,.5]]),c((l(),p(a,{sub:"",level:6},{default:r(()=>[F]),_:1})),[[i,2]]),c((l(),p(v,null,{default:r(()=>[n(f,{steps:e.steps,active:e.activeStep,onChangeStep:s[0]||(s[0]=o=>e.activeStep=o)},null,8,["steps","active"])]),_:1})),[[i,1]]),c(n(m,{files:e.files,active:e.activeFile,onChangeFile:s[1]||(s[1]=o=>e.activeFile=o)},null,8,["files","active"]),[[i,1]]),n(_,{component:"LvProgressSteps"})],64)}const V=u(k,[["render",B]]);export{V as default};
