import{_ as f,o as n,c as C,w as a,b as r,d as s,e as l,F as g,f as u,g as c,h as x}from"./index.f26ba42e.js";const T='<lv-chart :datasets="datasets" type="bar" :labels="labels" height="300px" />'.trim(),y='<lv-chart :datasets="datasets" :labels="labels" height="300px" />'.trim(),B=`
export default {
    data() {
        return {
