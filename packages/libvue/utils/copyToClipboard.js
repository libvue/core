export default function copyToClipboard(str) {
  ...
  const selected = document.getSelection().rangeCount > 0 // Check if  is any content selected prev
...
// credits: https://gist.github.com/interactiveRob/39a3eb36c7403f1ba43c190fc88f972f
